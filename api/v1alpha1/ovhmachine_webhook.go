...
//nolint:lll
// +kubebuilder:webhook:path=/validate-infrastructure-cluster-x-k8s-io-v1alpha1-ovhmachine,mutating=false,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=ovhmachines,verbs=create;update,versions=v1alpha1,name=vovhmachine.kb.io,admissionReviewVersions=v1
