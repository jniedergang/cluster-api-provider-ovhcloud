...
//nolint:lll
// +kubebuilder:webhook:path=/validate-infrastructure-cluster-x-k8s-io-v1alpha2-ovhcluster,mutating=false,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=ovhclusters,verbs=create;update,versions=v1alpha2,name=v2ovhcluster.kb.io,admissionReviewVersions=v1
